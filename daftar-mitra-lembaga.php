<?php 
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $telepon_lembaga = $_POST["telepon_lembaga"];
    $provinsi_lembaga = $_POST["provinsi_lembaga"];
    $kota_lembaga = $_POST["kota_lembaga"];
    ...
    //Validasi Telepon
    if (strlen($telepon_penyelenggara) > 16 || !preg_match('/^[0-9]+$/', $telepon_penyelenggara) || strlen($telepon_lembaga) > 16 || !preg_match('/^[0-9]+$/', $telepon_lembaga)) {
      $responseTelepon = "
          <div class='offset-m2 l6 offset-l3'>
            <div class='card-panel red lighten-2'>
    ...
    if (strlen($telepon_penyelenggara) == 0 || strlen($telepon_lembaga) == 0) {
      $responseTelepon = "
          <div class='offset-m2 l6 offset-l3'>
            <div class='card-panel red lighten-2'>
    ...
    //Validasi Lainnya
    if(strlen($nama_penyelenggara) == 0 || strlen($nama_lembaga) == 0 || strlen($nama_kursus) == 0 || strlen($email_penyelenggara) == 0 ||
      strlen($alamat_lembaga) == 0 || strlen($alamat_penyelenggara) == 0 ||
      strlen($jenis_kursus) == 0 || strlen($kota_lembaga) == 0 || strlen($kota_penyelenggara) == 0 || strlen($provinsi_lembaga) == 0 ||
  ...
  //Insert data
    ...
    $inset_lembaga_kursus = mysqli_query($connection, "
      INSERT INTO rumahsinau.lembaga_kursus (nama, alamat, telepon, id_pemilik, email_lembaga) 
      VALUES ('$nama_lembaga', '$alamat_lembaga', '$telepon_lembaga', '$id_pemilik', '$email_penyelenggara');
    ...
    $inset_kursus = mysqli_query($connection, "
      ...
      if ($inset_kursus && $inset_lembaga_kursus && $inset_penyelenggara_kursus) {
        $response_header = "
          <div class='offset-m2 l6 offset-l3'>
        ...
        $subjectToAdmin = "Pendaftaran Mitra Lembaga (" . $nama_kursus . ") (" . $nama_lembaga . ") (" . $date . ")";
...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container center">
        <h3 style="margin-top: 15%;" class="white-text">Form Pendaftaran Lembaga</h3>
      </div>
    </div>
  ...
  <div class="container">
    <div class="section">
      <div class="row">
        <div class="">
          <h4>Formulir Pendaftaran Mitra Lembaga</h4>
          <?php echo $response_header; ?>
            <div class="row">
              <form class="col s12" action="daftar-mitra-lembaga.php" method="post">
                <h5>Data Lembaga</h5>
                <div class="row">
                  <div class="input-field col s12">
                    <input id="nama_lembaga" name="nama_lembaga" type="text" class="validate">
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <input id="telepon_lembaga" name="telepon_lembaga" type="text" class="validate">
                    <label for="nama">Telepon Lembaga</label>
                    <?php echo $responseTelepon; ?>
                  </div>
                </div>
                <div class="row">
                  <div class="input-field col s6">
                    <select id="provinsi_lembaga" name="provinsi_lembaga">
                  ...
                  <div class="input-field col s6">
                    <input id="kota_lembaga" name="kota_lembaga" type="text" class="validate">
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <input id=id="alamat_lembaga" name="alamat_lembaga" type="text" class="validate">
                    <label for="nama">Alamat Lembaga</label>
                    <?php echo $response; ?>
                  </div>
                </div>
                <h5>Data Kursus</h5>
                ...
                <div class="input-field col s12">
                    ...
                    <div id="catatan">
                      ...
                      <script>
                        ...
                        var deskripsi = quill.children[0].innerHTML;
                        ...
                        var PageToSendTo = "daftar-mitra-lembaga.php?";
